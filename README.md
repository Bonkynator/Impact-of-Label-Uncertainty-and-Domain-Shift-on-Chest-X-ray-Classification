...
2. Download **CheXpert-v1.0-small** 
...
2. Download **NIH Chest X-rays**
4. Extract all to `data/NIH/`
...
This will:
1. Train all 3 models (U-Zeros, U-Ones, U-Half)
2. Evaluate each on CheXpert validation
3. Evaluate each on ChestX-ray14
...
2. **Compute loss**: Binary cross-entropy (allows soft labels)
